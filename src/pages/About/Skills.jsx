  ...
  return (
    <div className='my-10 lg:mx-[75px] md:mx-[40px] mx-0 md:pt-10 pt-4' data-aos='fade-up'>
        <div className='text-center px-6'>
            ...
            <p className="text-[--dark-grey] text-[18px] md:w-[95%] w-100 mx-auto leading-normal mt-2">I have over 10 years of experience building websites and web-based applications for companies across various industries. Below is a quick overview of my main technical skills and the tools I use.</p>
        </div>
        <div className='flex md:flex-row flex-wrap my-4 w-full gap-4 justify-center mt-20' data-aos="fade-up">
            ...
            <Swiper
                ...
                >
                    ...
                    <SwiperSlide>
                        <SkillsSlide img={backend} title="Backend" skills={backendSkills}  />
                    </SwiperSlide>
                    <SwiperSlide>
                        <SkillsSlide img={others} title="Others" skills={otherSkills}  />
                    </SwiperSlide>
                </Swiper>
            </>
            :
