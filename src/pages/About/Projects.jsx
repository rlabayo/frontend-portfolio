...
function Projects() {
  ...
  return (
    <div className='py-4 bg-gradient-to-b from-[#ffffff] to-[#FDF2F2]' data-aos='fade-up'>
                    ...
                    projects.map((val, key) => {
                        ...
                        return (
                            <SwiperSlide key={val.id}>
                                {
                                    val.flip === false ?
                                    <div className="card w-full rounded-lg rounded-b-lg my-1 md:h-[360px] h-[360px] min-h-full bg-cover bg-center mx-auto" key={val.id} style={{height: 360,backgroundImage : `url(${imgDisplay})`}} onClick={() => handleClickFlip(val.id)} ></div>
                                    :
                                    <div className="card w-full shadow-xl rounded-lg rounded-b-lg my-1 bg-white md:h-[360px] h-[360px] min-h-full mx-auto" key={val.id}>
                                        <div className='w-full my-auto'>
                                            <div className="w-full text-end">
                                                <button className='ml-auto px-4 font-bold text-[--bright-red]' onClick={() => handleCloseDetails(val.id)}>x</button>
                                            </div>
                                            <div className='px-6 py-2 overflow-y-auto md:min-h-[330px] h-[330px] overflow-auto'>
