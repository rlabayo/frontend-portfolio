...
function Projects() {
  ...
  return (
    <div className='my-10 bg-gray-100 shadow-md drop-shadow-md md:py-10 py-4' data-aos='fade-up'>
            ...
            <div className=' flex flex-wrap gap-2 justify-center'>
                {
                                ...
                                <SwiperSlide key={val.id}>
                                    {
                                        ...
                                        <div className="card lg:w-1/3 w-full max-w-md rounded-lg my-1 py-4 bg-white md:min-h-1/2 min-h-full mx-auto" key={val.id}>
                                            <div className='w-full my-auto'>
                                                ...
                                                <div className='px-6 overflow-y-auto md:min-h-[350px] h-[300px] overflow-auto'>
                    ...
                    projects.map((val, key) => {
                        return (
                            ...
                            :
                            <div className="card w-full max-w-md shadow-xl rounded-lg rounded-b-lg my-2 py-4 px-2 bg-white min-h-1/2" key={val.id} onMouseLeave={() => handleClickFlipBack(val.id)} >
                                <div className='w-full my-auto'>
