    ...
    <>
        <div className="w-full md:w-3/4 px-10 mx-auto flex flex-wrap justify-center mb-10">
            <div className='text-center md:w-1/2 w-full mt-4 p-4'>
                ...
                <p className='text-[--dark-grey] lg:text-[17px] text-[15px] md:leading-7 leading-4 mt-4 px-4'>Send me an email at rhea.labayo08@gmail.com.</p>
            </div>
            {/* <div className='text-center md:w-1/3 w-full mt-4 p-4'>
                ...
                <p className='text-[--dark-grey] lg:text-[17px] text-[15px] md:leading-7 leading-4 mt-4 px-4'>
            ...
            <div className='text-center md:w-1/2 w-full mt-10'>
                ...
                <p className='text-[--dark-grey] lg:text-[17px] text-[15px] md:leading-7 leading-4 mt-4'>
